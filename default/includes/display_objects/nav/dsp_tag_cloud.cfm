...
--->
<cfparam name="arguments.useCurrentID" default="false" type="boolean">
 
<cfif arguments.useCurrentID and not len(arguments.parentID)>
        <cfset arguments.parentID = $.content('contentID')>
</cfif>
